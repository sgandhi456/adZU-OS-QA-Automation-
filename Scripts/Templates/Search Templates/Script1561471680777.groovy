...
WebUI.callTestCase(findTestCase('Templates/Open Templates'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Templates/Search Template/Search Template Text'), 'Retina_Test')
